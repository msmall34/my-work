        ...
        <Slide bottom cascade>
            ...
            <div className='home-content max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <div className='w-40 btnHome lg:z-10'>
                    ...
                    <Link /* onClick={() => props.setSelectedItem('work')} */ to={'work'} smooth={true} duration={1000} className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-600 hover:border-pink-600'>
                        View Work 
