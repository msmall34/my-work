...
const Project = (props) => {
    ...
    const getProjectDetails = () => {
        ...
        const selectedProject = filteredProject.filter(projectItem => {
            

            return projectItem.projectId === projectId
        })
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center w-full md:w-[90%]">
                        <div className="w-full md:w-1/2 siteImage md:mr-[50px] mb-3">
                            <div className="mb-xs-30">
                                <img src={projectImages[project && project.imgUrl ? project.imgUrl : 0]} alt="projetImage"/>
                            </div>
                        </div>
                            ...
                            {project && project.siteUrl && 
                                <div className="mb-5 w-full">
                                    <div className='w-full md:w-1/2 text-center flex justify-start'>
                                        <a href={project && project.siteUrl ? project.siteUrl : "/"} className='text-white group border-2 px-6 py-3 my-2 flex items-center bg-theme-dark-100 border-theme-dark-100 hover:bg-pink-600 hover:border-pink-600' target="_blank" rel="noreferrer">
                                            Voir le site
